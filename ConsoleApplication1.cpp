...
int main()
{
	...
	*/
	...
	if (std::filesystem::exists("test.ini")) //change test.txt to the path of your file :smile:
	{
		if (!verifykey("test.ini", "User Info", "Username"))
		{
			std::string key = ReadFromIniFile("test.ini", "User Info", "License");
		...
		{
			std::string username = ReadFromIniFile("test.ini", "User Info", "Username");
			std::string password = ReadFromIniFile("test.ini", "User Info", "Password");
	...
	else
	{
		...
		{
			if (!WriteLicense("test.ini", key))
			{
				std::cout << skCrypt("Failed To Create File For Auto Login");
			}
			std::cout << skCrypt("Successfully Created File For Auto Login");
		}
		else
		{
			if (!WriteUserPass("test.ini", username, password))
			{
				std::cout << skCrypt("Failed To Create File For Auto Login");
			}
			std::cout << skCrypt("Successfully Created File For Auto Login");
